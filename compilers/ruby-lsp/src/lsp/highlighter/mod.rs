...
//!
//! This module provides functionality for syntax highlighting Ruby code.
...
impl RubyHighlighter {
    ...
    pub fn highlight(&self, text: &str) -> Vec<(usize, usize, String)> {
        ...
        let keywords = [
            "if", "unless", "elsif", "else", "case", "when", "then", "for", "while", "until", "break", "next", "redo", "retry", "return",
            "yield", "def", "class", "module", "end", "lambda", "proc", "begin", "rescue", "ensure", "raise", "require", "load", "include",
            "extend", "prepend", "and", "or", "not", "in", "true", "false", "nil", "super", "self", "alias", "undef", "defined", "do",
        ];
