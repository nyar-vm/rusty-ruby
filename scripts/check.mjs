...
async function main() {
    ...
    const jsChecks = [
        { name: "JavaScript/TypeScript Lint", fn: jsLint },
        { name: "JavaScript/TypeScript Test", fn: jsTest },
        { name: "JavaScript/TypeScript Build", fn: jsBuild },
    ];
    ...
    log(
        "cyan",
        `Total: ${results.length} | ${colors.green}Passed: ${passed.length}${colors.reset} | ${colors.red}Failed: ${failed.length}${colors.reset}`,
    );
